...
# teststrategy = imp.load_source(sys.argv[1], filepath)

#import strategy_seasonal_weekly as teststrategy 
#import strategy_Spike as teststrategy 
#import strategy_accumulation_distribution as teststrategy 
#import strategy_gaps as teststrategy 
...
def main():
    ...
    for instrument in instrumentListGetter():
        ...
        for params in teststrategy.parameters_generator():
            ...
            print "\n\nIteration %d / %d; Instrument %s ; %s Params %s" % (iteration, iterations,  instrument, shortlong, paramsstring )
